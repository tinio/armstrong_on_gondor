# Django settings for demo armstrong project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'armstrong.db',          # Or path to database file if using sqlite3.
...
SECRET_KEY = 'e0s@^yz2j-rjx*^vanw3&ja3tepyrhxm&*)xm7-8mq_xs1)p9s'
